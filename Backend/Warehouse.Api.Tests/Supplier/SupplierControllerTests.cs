...
public class SupplierControllerTests
{
	...
	public async Task CreateSupplier_ShouldReturnOk_WhenSuccessful()
	{
		...
		_supplierServiceMock.Setup(x => x.CreateSupplierAsync(request, It.IsAny<long>())).ReturnsAsync(expectedResponse);
	...
	public async Task CreateSupplier_ShouldReturnBadRequest_WhenServiceThrowsInvalidOperationException_DuplicateCode()
	{
		...
		_supplierServiceMock.Setup(x => x.CreateSupplierAsync(request, It.IsAny<long>())).ThrowsAsync(new InvalidOperationException("Duplicate supplier code"));
	...
	public async Task CreateSupplier_ShouldReturnOk_WithOptionalFields()
	{
		...
		_supplierServiceMock.Setup(x => x.CreateSupplierAsync(It.IsAny<CreateSupplierRequest>(), It.IsAny<long>())).ReturnsAsync(expectedResponse);
	...
	public async Task CreateSupplier_ShouldPassAllQueryParams_ToServiceCorrectly()
	{
		...
		_supplierServiceMock.Setup(x => x.CreateSupplierAsync(request, It.IsAny<long>())).ReturnsAsync(new SupplierResponse { SupplierName = "XYZ" }).Verifiable();

		await controller.CreateSupplier(request);
		_supplierServiceMock.Verify(x => x.CreateSupplierAsync(It.Is<CreateSupplierRequest>(req => req.SupplierName == "XYZ"), It.IsAny<long>()), Times.Once);
	}
	...
	public async Task UpdateSupplier_ShouldReturnOk_WhenSuccessful()
	{
		...
		_supplierServiceMock.Setup(x => x.UpdateSupplierAsync(1, request, It.IsAny<long>())).ReturnsAsync(expectedResponse);
	...
	public async Task UpdateSupplier_ShouldReturnNotFound_WhenSupplierDoesNotExist()
	{
		...
		_supplierServiceMock.Setup(x => x.UpdateSupplierAsync(1, request, It.IsAny<long>())).ThrowsAsync(new KeyNotFoundException("Supplier not found"));
	...
	public async Task UpdateSupplier_ShouldReturnBadRequest_WhenLogicThrowsInvalidOperationException()
	{
		...
		SetupUserClaims(controller);
		var request = new UpdateSupplierRequest();
		_supplierServiceMock.Setup(x => x.UpdateSupplierAsync(1, request, It.IsAny<long>())).ThrowsAsync(new InvalidOperationException("Invalid operation"));
	...
	public async Task UpdateSupplier_ShouldPassIdCorrectly_ToService()
	{
		...
		SetupUserClaims(controller);
		var request = new UpdateSupplierRequest();
		_supplierServiceMock.Setup(x => x.UpdateSupplierAsync(999, request, It.IsAny<long>())).ReturnsAsync(new SupplierResponse { SupplierId = 999 }).Verifiable();

		await controller.UpdateSupplier(999, request);
		_supplierServiceMock.Verify(x => x.UpdateSupplierAsync(999, request, It.IsAny<long>()), Times.Once);
	}
