...
public partial class Mkiwms3Context : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.AuditLogId).HasName("PK__AuditLog__EB5F6CBDF23CA6F3");
        ...
        {
            entity.HasKey(e => e.BrandId).HasName("PK__Brands__DAD4F05EACC0946F");

            entity.HasIndex(e => e.BrandName, "UQ__Brands__2206CE9B40700395").IsUnique();
        ...
        {
            entity.HasKey(e => e.CertificateId).HasName("PK__Certific__BBF8A7C107416FEB");
        ...
        {
            entity.HasKey(e => e.ApprovalId).HasName("PK__Document__328477F4C6637E75");
        ...
        {
            entity.HasKey(e => e.AttachmentId).HasName("PK__Document__442C64BEC7AFBDB1");
        ...
        {
            entity.HasKey(e => e.Gdnid).HasName("PK__GoodsDel__9FDAF9A7C880A14C");

            entity.HasIndex(e => e.Gdncode, "UQ__GoodsDel__1DA6F0E990FC7866").IsUnique();
        ...
        {
            entity.HasKey(e => e.GdnlineId).HasName("PK__GoodsDel__0E39BC616081B5ED");
        ...
        {
            entity.HasKey(e => e.Grnid).HasName("PK__GoodsRec__BC0E8C42CC4B5979");

            entity.HasIndex(e => e.Grncode, "UQ__GoodsRec__F1E8DDCB03761BB7").IsUnique();
        ...
        {
            entity.HasKey(e => e.GrnlineId).HasName("PK__GoodsRec__433F1E9007876DE5");
        ...
        {
            entity.HasKey(e => e.AdjustmentLineId).HasName("PK__Inventor__A70FA5C152D3BB8C");
        ...
        {
            entity.HasKey(e => e.AdjustmentId).HasName("PK__Inventor__E60DB893188DAE2E");

            entity.HasIndex(e => e.AdjustmentCode, "UQ__Inventor__292CC6CF77C14171").IsUnique();
        ...
        {
            entity.HasKey(e => e.InventoryId).HasName("PK__Inventor__F5FDE6B375D3D9DC");
        ...
        {
            entity.HasKey(e => e.InventoryTxnId).HasName("PK__Inventor__F692919B2E382EC2");
        ...
        {
            entity.HasKey(e => e.InventoryTxnLineId).HasName("PK__Inventor__EE94D3FA8EC4BB06");
        ...
        {
            entity.HasKey(e => e.ItemId).HasName("PK__Items__727E838BEE235588");

            entity.HasIndex(e => e.ItemCode, "UQ__Items__3ECC0FEA67D676B8").IsUnique();
        ...
        {
            entity.HasKey(e => e.CategoryId).HasName("PK__ItemCate__19093A0B4D6EDEBC");

            entity.HasIndex(e => e.CategoryCode, "UQ__ItemCate__371BA955BB596769").IsUnique();
        ...
        {
            entity.HasKey(e => e.ParamId).HasName("PK__ItemPara__C132B124CA723064");

            entity.HasIndex(e => e.ParamCode, "UQ__ItemPara__2232AFCB4F6638D2").IsUnique();
        ...
        {
            entity.HasKey(e => e.ItemParamValueId).HasName("PK__ItemPara__B90EB55FD777833B");
        ...
        {
            entity.HasKey(e => e.ItemPriceId).HasName("PK__ItemPric__7E70A2628FD75157");
        ...
        {
            entity.HasKey(e => e.ItemWarehousePolicyId).HasName("PK__ItemWare__6813183E9EB838D4");
        ...
        {
            entity.HasKey(e => e.NotificationId).HasName("PK__Notifica__20CF2E124D5A8A63");
        ...
        {
            entity.HasKey(e => e.PackagingSpecId).HasName("PK__Packagin__DAD5791C6FD794E7");

            entity.HasIndex(e => e.SpecCode, "UQ__Packagin__BB4FDCAD935B7FFF").IsUnique();
        ...
        {
            entity.HasKey(e => e.TokenId).HasName("PK__Password__658FEEEAFDCD9154");
        ...
        {
            entity.HasKey(e => e.PurchaseOrderId).HasName("PK__Purchase__036BACA4F5EF6A59");

            entity.HasIndex(e => e.Pocode, "UQ__Purchase__40ACF5B85A538438").IsUnique();
        ...
        {
            entity.HasKey(e => e.PurchaseOrderLineId).HasName("PK__Purchase__2100B03835D23C92");
        ...
        {
            entity.HasKey(e => e.ReceiverId).HasName("PK__Receiver__FEBB5F27CE9F2B3B");

            entity.HasIndex(e => e.ReceiverCode, "UQ__Receiver__A918ECE94E22FBF4").IsUnique();
        ...
        {
            entity.HasKey(e => e.ReleaseRequestId).HasName("PK__ReleaseR__2901DDA4932E8118");

            entity.HasIndex(e => e.ReleaseRequestCode, "UQ__ReleaseR__380806C56D8E3027").IsUnique();
        ...
        {
            entity.HasKey(e => e.ReleaseRequestLineId).HasName("PK__ReleaseR__B16BBFF5217784AB");
        ...
        {
            entity.HasKey(e => e.RoleId).HasName("PK__Roles__8AFACE1A7ADA467E");

            entity.HasIndex(e => e.RoleCode, "UQ__Roles__D62CB59C909AB164").IsUnique();
        ...
        {
            entity.HasKey(e => e.StocktakeLineId).HasName("PK__Stocktak__CE77AE36727897CB");
        ...
        {
            entity.HasKey(e => e.StocktakeId).HasName("PK__Stocktak__5874C465C805FFC8");

            entity.HasIndex(e => e.StocktakeCode, "UQ__Stocktak__66FC570995788874").IsUnique();
        ...
        {
            entity.HasKey(e => e.SupplierId).HasName("PK__Supplier__4BE666B4065A72A9");

            entity.HasIndex(e => e.SupplierCode, "UQ__Supplier__44BE981BD9A7E569").IsUnique();
        ...
        {
            entity.HasKey(e => e.UomId).HasName("PK__UnitOfMe__F6F8D47E4478D29C");

            entity.ToTable("UnitOfMeasure");

            entity.HasIndex(e => e.UomCode, "UQ__UnitOfMe__562A6DA7326B0AD0").IsUnique();
        ...
        {
            entity.HasKey(e => e.UserId).HasName("PK__Users__1788CC4C4D415512");

            entity.HasIndex(e => e.Username, "UQ__Users__536C85E4AED7D0A7").IsUnique();

            entity.HasIndex(e => e.Email, "UQ__Users__A9D10534E3F7420B").IsUnique();
        ...
        {
            entity.HasKey(e => e.UserRoleId).HasName("PK__UserRole__3D978A355DEEE49B");
        ...
        {
            entity.HasKey(e => e.WarehouseId).HasName("PK__Warehous__2608AFF9674A1023");

            entity.HasIndex(e => e.WarehouseCode, "UQ__Warehous__1686A0564F1425DE").IsUnique();
