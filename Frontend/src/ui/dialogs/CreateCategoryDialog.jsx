...
import { createCategory } from '../../shared/lib/categoryService';

/**
 * Dialog tạo danh mục (category) mới.
 * Dùng chung cho CreateItem, ViewItemDetail.
 */
export function CreateCategoryDialog({ open, onClose, onSuccess }) {
    ...
    const handleSubmit = async (e) => {
        ...
        setError(null);
        try {
            const result = await createCategory({ categoryName: name });
            setCategoryName('');
            onSuccess?.(result);
            onClose();
        } catch (err) {
