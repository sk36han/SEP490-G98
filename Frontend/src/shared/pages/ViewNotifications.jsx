...
const MOCK_NOTIFICATIONS_BY_ROLE = {
    ...
    SALE_SUPPORT: [
        { id: '1', title: 'Yêu cầu nhập hàng (PO) mới', message: 'Yêu cầu nhập hàng #PO-2025-024 đã được tạo và chờ xử lý.',         time: '20 phút trước', icon: ShoppingCart, isNew: true,  type: 'info'    },
